...
class SimpleSearchCacheService:
    ...
    def get_search_results(self, query: str, user_uuid: str,
                          item_types: Optional[List[str]] = None,
                          limit: int = 50, offset: int = 0,
    ...
    def store_search_results(self, query: str, user_uuid: str, results: List[Dict],
                           item_types: Optional[List[str]] = None,
                           limit: int = 50, offset: int = 0,
    ...
    def invalidate_user_cache(self, user_uuid: str, reason: str = "data_update"):
        """
        ...
        keys_to_remove = [
            ...
            if key.endswith(f"|{user_uuid}")  # Keys end with user_uuid
        ]
    ...
    def invalidate_all_cache(self, reason: str = "system_maintenance"):
    ...
    def invalidate_query_cache(self, query: str, reason: str = "content_change"):
    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "memory_usage_kb": round(self._estimate_memory_usage() / 1024, 2),
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        return {
            "status": "healthy",
            "cache_size": len(self._cache),
            "expired_entries": len([e for e in self._cache.values() if e["expired"]]),
